...
<div class="row bg-title">
    ...
    @if(isset($model))
        ...
        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12" style="display: inline-block">
            ...
            @else
                <a href="{{ url('admin/fish-table') }}" style="color: black;"><h4 class="page-title" style="">Рыбы</h4>
                </a>
            @endif
        ...
        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12" style="display: inline-block">
            ...
            @else
                <a href="{{ url('admin/lake-table') }}" style="color: black;"><h4 class="page-title" style="">
                        Водоемы</h4></a>
            @endif
        ...
        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12" style="display: inline-block">
            ...
            @else
                <a href="{{ url('admin/location-table') }}" style="color: black;"><h4 class="page-title" style="">
                        Локации</h4></a>
            @endif
        ...
        <div class="col-lg-2 col-md-4 col-sm-4 col-xs-12" style="display: inline-block">
            ...
            @else
                <a href="{{ url('admin/category-table') }}" style="color: black;"><h4 class="page-title" style="">
                        Категории рыб</h4></a>
            @endif
